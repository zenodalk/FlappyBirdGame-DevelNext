...
class GameOver extends AbstractForm
{
     ...
     **/
    function doLabelAltClick(UXMouseEvent $event = null)
    {
        $this->originForm('App')->game->phys->loadScene('Level1');

        // +Actions: 1 //
    }

    /**
     * @event scoreLabel.construct 
     **/
    function doScoreLabelConstruct(UXEvent $event = null)
    {
        global $resultScore;
        
        $event->sender->text = $resultScore;     
    }
}
